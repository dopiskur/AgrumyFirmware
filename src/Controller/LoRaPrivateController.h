...
/// node picks itself, not negotiated with a network server. The radio pin mapping (Heltec WiFi LoRa
/// 32 V3, ESP32-S3+SX1262) and the whole uplink/downlink cycle are UNVERIFIED against real hardware.
