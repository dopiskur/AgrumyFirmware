...
// True if the last I2C write to the PCF8574 relay expander failed (bus hung/expander not physically present) - meaningless for a direct-GPIO board (i2cAddress==0) since no I2C write is ever attempted there.
